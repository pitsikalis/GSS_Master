...
namespace NaughtyCharacter
{
	...
	public class Character : MonoBehaviour
	{
		...
		[HideInInspector]
		public float _verticalSpeed; // In meters/second
		...
		private void Update()
		{
			...
			impact = Vector3.Lerp(impact, Vector3.zero, 100 * Time.deltaTime);
			////////////////////////////////////////////////
		}
		...
		public void MakePlayerJump() ///////////TO BE CHANGED  Needs to be intergrated to ExplosionImpactIK script where it can dentify which characters are in range and apply impact based on their direction//////
		{
				...
				//float acceleration = _hasMovementInput ? MovementSettings.Acceleration : MovementSettings.Decceleration;
				//_horizontalSpeed = Mathf.MoveTowards(-10, 10, acceleration * Time.deltaTime);


			_lastMovementInput.Normalize();
			if (_lastMovementInput.y < 0) _lastMovementInput.y = -_lastMovementInput.y; // reflect down force on the ground
			impact += _lastMovementInput.normalized * force / mass;
